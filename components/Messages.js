...
export default function Messages() {
    ...
    useEffect(() => {
        ...
        setMessagereq(allusers.messagesloading);


    }, [allusers.messagesloading]);
    ...
    useEffect(() => {
        if (userred && userred._id != "") {
            ...
            dispatch({type: "messagereqloading"});
    ...
    return (
        <SafeAreaView style={Mystyles.messagesview}>
            ...
            <View style={Mystyles.chatboxview}>
                <View style={Mystyles.flatlistconatinerview}>
                    {allusers.inbox && allusers.inbox.length > 0 ?
                        ...
                        />
                        : <View style={Mystyles.nomessagesview}><Text>You do not have any messages yet </Text></View>
                    }
                </View>
                {allusers.inbox && allusers.inbox.length > 0 ?
            ...
            {
                messagereq == true ? <Pageloader /> : null
            }
...
const Mystyles = StyleSheet.create({
    ...
    nomessagesview: {justifyContent: "center", alignItems: "center"}
